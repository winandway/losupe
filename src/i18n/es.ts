export const es = {
  ...
  home: {
    archive: "Del archivo",
    archiveHint: "Notas anteriores que siguen siendo útiles.",
    latest: "Lo último",
  ...
  contact: {
    title: "Contacto",
    intro:
      "Escríbenos. Leemos todos los mensajes y contestamos, normalmente el mismo día laborable.",
    whoTitle: "Quién responde",
    who: "Los mensajes los recibe la redacción de losupe.com. Si escribes por una corrección en una nota publicada, dinos el enlace y qué dato crees que está mal: lo revisamos y lo corregimos con una nota al pie, tal como dice nuestra política editorial.",
    emailTitle: "Correo directo",
    publisherTitle: "Responsable de la publicación",
    publisher: "losupe.com es un medio editado por Windoce LLC, con sede en Estados Unidos.",
    reasonsTitle: "Para qué escribirnos",
    reasons: [
      "Corregir un dato de una nota publicada",
      "Proponer un tema o mandarnos información",
      "Contratar una nota patrocinada o publicidad",
      "Prensa, alianzas y todo lo demás",
    ],
    name: "Tu nombre",
    email: "Tu correo",
    subject: "Asunto",
    ...
    send: "Enviar mensaje",
    sending: "Enviando…",
    thanks: "Gracias, recibimos tu mensaje. Te contestamos a ese correo.",
    invalid: "Revisa los datos: hace falta tu nombre, un correo válido y un mensaje.",
    mailDown: "No pudimos enviarlo ahora mismo. Escríbenos directamente al correo de arriba.",
    namePlaceholder: "Nombre y apellido",
    emailPlaceholder: "correo@ejemplo.com",
    subjectPlaceholder: "De qué se trata",
    messagePlaceholder:
      "Cuéntanos con detalle. Si es una corrección, incluye el enlace de la nota.",
  },
  about: {
    publisherTitle: "Quién edita losupe",
  ...
  panel: {
    ...
    dashboard: {
      ...
      redesHint:
        "Cada nota se anuncia sola en las redes que estén encendidas. La red que no tenga sus llaves se salta sin molestar.",
      redesOn: "encendida",
      redesOff: "apagada",
      redesFaltan: "faltan",
      redesUltimos: "Últimos anuncios",
      redesVacio: "Todavía no se ha anunciado ninguna nota.",
      present: "configurada",
      absent: "falta",
      budget: "Gasto de hoy",
      of: "de",
    ...
    mailSettings: {
      ...
      digest: "Boletín de resumen",
      digestEvery: "Uno cada {n} días, con lo mejor",
      digestOff: "Apagado",
      digestNext: "El siguiente sale el {fecha}.",
      digestFirst: "Sale en cuanto haya alguien confirmado.",
    ...
    traffic: {
      ...
      onlineHint:
        "Personas con la página abierta y a la vista en los últimos {min} minutos. No se cuentan robots ni rastreadores.",
      readers: "lectores",
      readings: "lecturas",
      avgTime: "Tiempo medio",
      byDay: "Día a día (últimos 30 días)",
      origins: "Por dónde llegan",
      originsHint: "Últimos 30 días.",
      referrers: "Sitios que más nos traen",
      countries: "De dónde nos leen",
      mostRead: "Lo más leído",
      mostReadHint: "Últimos 30 días, con cuánto tiempo pasan en cada nota.",
      page: "Página",
      empty: "Todavía no hay datos de este periodo.",
      privacy:
        "Contador propio: sin Google Analytics, sin rastreadores de terceros, sin cookies y sin guardar direcciones IP. Se cuenta a las personas con una huella anónima que cambia cada día. El detalle se borra solo a los {dias} días.",
      since: "Hay registro desde {fecha}.",
    },
    sponsors: {
