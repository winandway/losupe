...
export const en: Dict = {
  ...
  panel: {
    ...
    dashboard: {
      ...
      redesHint:
        "Every story announces itself on whichever networks are switched on. A network without its keys is skipped quietly.",
      redesOn: "on",
      redesOff: "off",
      redesFaltan: "missing",
      redesUltimos: "Latest posts",
      redesVacio: "No story has been announced yet.",
      present: "set",
      absent: "missing",
      budget: "Spent today",
      of: "of",
    ...
    mailSettings: {
      ...
      digestEvery: "One every {n} days, with the best of it",
      digestOff: "Off",
      digestNext: "Next one goes out on {fecha}.",
      digestFirst: "It goes out as soon as someone confirms.",
    ...
    traffic: {
      ...
      onlineHint:
        "People with the page open and in view in the last {min} minutes. Bots and crawlers are not counted.",
      readers: "readers",
      readings: "reads",
      avgTime: "Average time",
      byDay: "Day by day (last 30 days)",
      origins: "How they get here",
      originsHint: "Last 30 days.",
      referrers: "Sites sending us the most",
      countries: "Where they read us from",
      mostRead: "Most read",
      mostReadHint: "Last 30 days, with how long they spend on each story.",
      page: "Page",
      empty: "No data for this period yet.",
      privacy:
        "Our own counter: no Google Analytics, no third-party trackers, no cookies and no IP addresses stored. People are counted with an anonymous fingerprint that changes daily. Detail is deleted after {dias} days.",
      since: "Records start on {fecha}.",
    },
    sponsors: {
