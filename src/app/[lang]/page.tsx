  ...
  return (
    <>
      ...
      {hero ? (
        ...
        <section className="rounded-2xl bg-ink px-6 py-12 text-white md:px-12">
          <h1 className="font-display text-4xl font-bold md:text-5xl">{dict.home.welcomeTitle}</h1>
          <p className="mt-4 max-w-2xl text-lg text-white/80">{dict.home.welcomeBody}</p>
          <p className="mt-6 text-sm text-accent">{dict.home.empty}</p>
        </section>
      )}
